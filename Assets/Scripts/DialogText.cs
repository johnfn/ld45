...
public class DialogText {
  public static string CuriosityColor = "#6699ff";
  ...
  public static List<DialogEvent> FirstDialog = new List<DialogEvent> {
    ...
    new DialogEvent { Name = CharacterName.Ash  , Contents = $"<color={ CuriosityColor }>Hey!</color>" },
    ...
    new DialogEvent { Name = CharacterName.Blank, Contents = "..." },
    new DialogEvent { Name = CharacterName.Ash  , Contents = "Hey, we can’t figure out what’s going on until you talk to me. Aren't you <color=#6699ff>curious</color>, too?" },
    ...
    new DialogEvent { Name = CharacterName.Blank, Contents = $"<color={ CuriosityColor }>...curious?...</color>" },
