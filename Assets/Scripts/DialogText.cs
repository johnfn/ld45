...
public class DialogText {
  ...
  public static List<DialogEvent> GateGood = new List<DialogEvent> {
      ...
      new DialogEvent { Name = CharacterName.Blank, Contents = "Slate? What are you talking about? Why can’t I see anything?" },
      new DialogEvent { Name = CharacterName.Ash, Contents = Ash("Do you think you’re the first person to show up in Lake Rasa?") },
      new DialogEvent { Name = CharacterName.Ash, Contents = Ash("I fell into that lake, just like you. And he found me.") },
      new DialogEvent { Name = CharacterName.Ash, Contents = Ash("He helped me learn curiosity, compassion, affection, remorse. All the things that made me… you know. Me.") },
      new DialogEvent { Name = CharacterName.Ash, Contents = Ash("And then he took it all away. He left.") },
      new DialogEvent { Name = CharacterName.Ash, Contents = Ash("And you can’t get those emotions back. You can only learn them once.") },
      new DialogEvent { Name = CharacterName.Blank, Contents = "I...I’m sorry." },
      new DialogEvent { Name = CharacterName.Ash, Contents = Ash("And the worst part?") },
      new DialogEvent { Name = CharacterName.Ash, Contents = Ash("I miss him.") },
      new DialogEvent { Name = CharacterName.Ash, Contents = Ash("I still miss him.") },
      new DialogEvent { Name = CharacterName.Ash, Contents = Ash("So please, when I leave…") },
      new DialogEvent { Name = CharacterName.Blank, Contents = "Ash, wait—!" },
      new DialogEvent { Name = CharacterName.Ash, Contents = Ash("Forget about me.") },
